...
SECRET_KEY = 'django-insecure-x^bma0i%8nh6a+1s$j*kjrwv4^7+=eln1j8_e7-h#n1iz&@s%)'
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console'],
        'level': 'DEBUG',  # This sets the global log level
    },
    'loggers': {
        'feedbacksystem': {  # Root logger for your whole project
            'handlers': ['console'],
